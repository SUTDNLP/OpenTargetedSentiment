...
#ifndef SRC_MultiDiscreteCRFMMLabeler_H_
#define SRC_MultiDiscreteCRFMMLabeler_H_


#include "N3L.h"
#include "basic/MultiDiscreteCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  MultiDiscreteCRFMMClassifier<gpu> m_classifier;
#else
  MultiDiscreteCRFMMClassifier<cpu> m_classifier;
#endif
...
#endif /* SRC_MultiDiscreteCRFMMLabeler_H_ */
