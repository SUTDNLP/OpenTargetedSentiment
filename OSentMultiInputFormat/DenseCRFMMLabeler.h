...
#ifndef SRC_DenseCRFMMLabeler_H_
#define SRC_DenseCRFMMLabeler_H_


#include "N3L.h"
#include "basic/DenseCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  DenseCRFMMClassifier<gpu> m_classifier;
#else
  DenseCRFMMClassifier<cpu> m_classifier;
#endif
...
#endif /* SRC_DenseCRFMMLabeler_H_ */
