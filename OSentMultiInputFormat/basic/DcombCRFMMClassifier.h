...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, int wordcontext, int label2Size, int hiddenSize,
    ...
    _olayer_denselinear2.initial(_label2Size, _hiddenSize, false, 40, 2);
    _sparselayer_linear.initial(_linearHiddenSize, _linearfeatSize, false, 50, 0);
    _olayer_sparselinear2.initial(_label2Size, _linearHiddenSize, false, 60, 2);
