...
void Labeler::train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile,
  ...
  m_classifier.init(wordEmb, m_options.wordcontext, m_label1Alphabet.size(),m_label2Alphabet.size(), m_options.hiddenSize, m_options.linearHiddenSize, m_featAlphabet.size());
