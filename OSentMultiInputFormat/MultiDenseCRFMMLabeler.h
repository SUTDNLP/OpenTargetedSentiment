...
#ifndef SRC_MultiDenseCRFMMLabeler_H_
#define SRC_MultiDenseCRFMMLabeler_H_


#include "N3L.h"
#include "basic/MultiDenseCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  MultiDenseCRFMMClassifier<gpu> m_classifier;
#else
  MultiDenseCRFMMClassifier<cpu> m_classifier;
#endif
...
#endif /* SRC_MultiDenseCRFMMLabeler_H_ */
