...
void Labeler::train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile,
  ...
  m_classifier.init(wordEmb, 2*m_options.wordcontext+1, m_label2Alphabet.size(), m_options.hiddenSize, m_options.atomLayers, m_options.linearHiddenSize, m_featAlphabet.size());
